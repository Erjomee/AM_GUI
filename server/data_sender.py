...
def temperatureUpdate():
    ...
    for i in range(10000):
        ...
        info_dict["LH_Abd_Temp"] = float(random.randint(0, 100))
        info_dict["LH_Rot_Temp"] = float(random.randint(0, 100))
        info_dict["LH_Flex_Temp"] = float(random.randint(0, 100))
        info_dict["LK_Temp"] = float(random.randint(0, 100))
        info_dict["LA_Lat_Temp"] = float(random.randint(0, 100))
        info_dict["LA_Med_Temp"] = float(random.randint(0, 100))

        info_dict["RH_Abd_Temp"] = float(random.randint(0, 100))
        info_dict["RH_Rot_Temp"] = float(random.randint(0, 100))
        info_dict["RH_Flex_Temp"] = float(random.randint(0, 100))
